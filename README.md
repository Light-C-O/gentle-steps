...
- **Friday 27th Feb:**
  ...
  - I will be added the auth page and home page together. I believe there is no need to make it seperate, espaecially for what I'll be doing. I have transfered everthing from the HomePage to the AuthPage. For now, I'll not delete in the HomePage yet. I wan to make sure everything works before doing so permanently.