      ...
      <div className="relative w-[90vw] max-w-3xl aspect-3/4 overflow-hidden">
        ...
        <div className="relative flex flex-col items-center justify-center h-full px-[8%]">
            ...
            <div className="grid">
              ...
              <div className="justify-self-center w-40 sm:w-100 h-auto mb-5 md:mb-10 border-2 rounded-full border-red-900 dark:border-gray-800"><img src="../transparent-logo_2.png" alt="main logo" className="mx-auto"/></div>
              
              {/* link to the chapters page */}
              <Link href="/chapters" className="bg-amber-400 hover:bg-amber-600 text-[clamp(20px,4vw,30px)] text-gray-900 hover:text-gray-100 p-2 sm:p-4 rounded-2xl dark:text-gray-100 text-center dark:hover:bg-indigo-500 dark:bg-blue-500 cursor-pointer">
              Open Book 
              </Link> 
            </div> 
        </div>
