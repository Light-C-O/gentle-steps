    ...
    return(
        <main className="flex justify-center mx-auto min-h-auto font-sans drop-shadow-xl/50 mt-10">
            <div className="relative w-[90vw] max-w-3xl">
                <img src="/book2.svg" alt="background paper" className="absolute inset-0 w-full h-auto object-contain"/>
                
                <div className="relative z-10 flex flex-col h-full px-[8%] md:grid grid-cols-2">
                    <div className="text-amber-800">You are now logged out!</div>
                    {/* <div><NavBar/></div> */}
                    <div className="">
                    ...
                    {reviews.map((review: any) => (
                        <div key={review.id} className="mb-6 p-4 border rounded-xl">
                            <p className="text-gray-600">{review.rating} out 5 Stars</p>
